export const MODULES = [
  ...
  { id: 'tplmap', name: 'SSTI Scan (Tplmap)', num: 32, phase: 4, tool: 'tplmap' },
  { id: 'crlfuzz', name: 'CRLF Injection (CRLFuzz)', num: 33, phase: 4, tool: 'crlfuzz' },
  { id: 'nomore403', name: '403 Bypass (nomore403)', num: 37, phase: 4, tool: 'nomore403' },
...
export const SCAN_MODES = [
  ...
  { id: 'full_spectrum', name: 'Full Spectrum', desc: 'All 37 modules, 5 phases', icon: 'Globe' },
