export const MODULES = [
  ...
  { id: 'dnsbrute', name: 'DNS Bruteforce', num: 17, phase: 1, tool: 'massdns + PureDNS + AlterX' },
  { id: 'tlsx', name: 'TLS Certificate Scan', num: 36, phase: 1, tool: 'tlsx' },
  { id: 'asn', name: 'ASN Discovery', num: 24, phase: 1, tool: 'asnmap' },
  { id: 'cloud', name: 'Cloud Asset Discovery', num: 25, phase: 1, tool: 'Python' },
  { id: 'github', name: 'GitHub Dorking', num: 26, phase: 1, tool: 'GitHub API' },
  { id: 'osint', name: 'OSINT Harvesting', num: 27, phase: 1, tool: 'theHarvester' },
  { id: 'shodan', name: 'Shodan Recon', num: 28, phase: 1, tool: 'Shodan API' },
  { id: 'ports', name: 'Fast Port Scan', num: 4, phase: 2, tool: 'Naabu / Nmap' },
  { id: 'fullports', name: 'Full Port Scan', num: 5, phase: 2, tool: 'Nmap' },
  { id: 'waf', name: 'WAF Detection', num: 7, phase: 2, tool: 'wafw00f + WhatWaf' },
  ...
  { id: 'internetdb', name: 'InternetDB Lookup', num: 34, phase: 2, tool: 'InternetDB' },
  { id: 'nikto', name: 'Nikto Web Server Scan', num: 35, phase: 2, tool: 'nikto' },
  ...
  { id: 'cariddi', name: 'Cariddi Crawl', num: 30, phase: 3, tool: 'cariddi' },
  { id: 'vuln', name: 'Vulnerability Scan', num: 8, phase: 4, tool: 'Nuclei' },
  { id: 'jaeles', name: 'Jaeles Vuln Scan', num: 31, phase: 4, tool: 'jaeles' },
  ...
  { id: 'tplmap', name: 'SSTI Scan (Tplmap)', num: 32, phase: 5, tool: 'tplmap' },
  { id: 'crlfuzz', name: 'CRLF Injection (CRLFuzz)', num: 33, phase: 5, tool: 'crlfuzz' },
  { id: 'nomore403', name: '403 Bypass (nomore403)', num: 37, phase: 5, tool: 'nomore403' },
...
export const PHASES = {
  ...
  5: { name: 'Targeted Exploitation', color: '#EF4444' },
};
